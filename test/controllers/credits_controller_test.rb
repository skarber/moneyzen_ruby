...
class CreditsControllerTest < ActionController::TestCase
  ...
  test "should create credit" do
    assert_difference('Credit.count') do
      post :create, credit: { amount: @credit.amount, email: @credit.email, payment: @credit.payment, status: @credit.status, term: @credit.term }
    end
  ...
  test "should update credit" do
    patch :update, id: @credit, credit: { amount: @credit.amount, email: @credit.email, payment: @credit.payment, status: @credit.status, term: @credit.term }
    assert_redirected_to credit_path(assigns(:credit))
  end
